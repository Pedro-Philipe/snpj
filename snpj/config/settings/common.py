# -*- coding: utf-8 -*-
"""
Django settings for snpj project.
...
DATABASES = {
    ...
    'default': env.db("DATABASE_URL", default="postgres://postgres:1234@localhost/dbsnpj"),
    # 'default': env.db("DATABASE_URL", default="sqlite:////" + str(ROOT_DIR) + "snpj.sqlite"),
